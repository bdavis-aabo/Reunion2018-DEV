...
<?php get_header() ?>
  ...
  <section class="homepage-introduction page-introduction" <?php if($_bg != ''): ?>style="background: url('<?php echo $_bg['url'] ?>') no-repeat right 60%;"<?php endif; ?> <?php if(is_page('privacy-policy')): ?>style="text-align:left;"<?php endif; ?>>
    <div class="container">
