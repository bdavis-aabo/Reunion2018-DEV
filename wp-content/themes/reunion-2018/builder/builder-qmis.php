            ...
            <?php endwhile; else: ?>
              <div class="col-12">
                <div class="builder-nohome">
                  <h2>There are no quick move-in inventory homes currently available from this builder. Please call the sales office @ <?php echo get_field('homebuilder_phone') ?> for more information.</h2>
                </div>
              </div>
