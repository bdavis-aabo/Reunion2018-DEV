...
class Ajax {
	 ...
	 * @since 1.0.0
	 */
	function albums_sort_galleries() {
	 ...
	 * @since 1.3.0
	 */
	function albums_editor_get_albums() {
		...
		foreach ( (array) $albums as $album ) {
			...
			$first_gallery = $first_gallery != false ? get_post_meta( $first_gallery, '_eg_gallery_data', true ) : false;
	 ...
	 * @since 1.1.0.3
	 */
	function albums_search_galleries() {
	 ...
	 * @since 1.0.0
	 */
	function albums_update_gallery() {
	 ...
	 * @since 1.3.0
	 */
	function albums_get_gallery_images() {
