...
class Metaboxes {
	...
	public function admin_notice_warnings() {
		...
		if ( isset( $_GET['envira_album_slug_exists'] ) ) {
	...
	public function save_meta_boxes( $post_id, $post ) {
		...
		$settings['config']['back_location']            = sanitize_text_field( esc_attr( $_POST['_eg_album_data']['config']['back_location'] ) );
		...
		if ( isset( $_POST['_eg_album_data']['config']['gallery_description_display'] ) ) {
			$settings['config']['gallery_description_display'] = sanitize_text_field( esc_attr( $_POST['_eg_album_data']['config']['gallery_description_display'] ) );
		}
		...
		envira_flush_album_caches( $post_id, $settings['config']['slug'] );
