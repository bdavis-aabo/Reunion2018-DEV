...
jQuery( document ).ready( function( $ ) {
    ...
    */
    ...
    $('.widgets-sortables').on('click', 'div.widget-top', function(event, element) {
        ...
        var previous_selection =  $('#'+the_id+' select.form-control').val(),
            previous_selection_text = $('#'+the_id+' select.form-control option:selected').text();


        /* clear to prevent duplicates */

        $('#'+the_id+' select.form-control').find('option').remove();
            ...
            fetch(ajaxurl, {
              ...
              response.json().then(function(data) {
                ...
                if ( previous_selection !== undefined ) {
                    singleFetch.setValueByChoice(previous_selection);
                }
    ...
    $(document).on('widget-updated', function(event, widget){
        ...
        var previous_selection =  $('#'+widget_id+' select.form-control').val(),
            previous_selection_text = $('#'+widget_id+' select.form-control option:selected').text();

        /* clear to prevent duplicates */

        $('#'+widget_id+' select.form-control').find('option').remove();
