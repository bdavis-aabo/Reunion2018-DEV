					...
					<tbody>
						...
						<tr id="envira-config-sorting-box">
							...
							<td>
								...
								<p class="description"><?php _e( 'Choose the sort order for your photos.', 'envira-gallery' ); ?></p>
							</td>
						</tr>
			...
			<table class="form-table">
				<tbody>
					...
					<tr id="envira-config-import-box">
						<th scope="row">
							<label for="envira-config-import-gallery"><?php _e( 'Import Gallery', 'envira-gallery' ); ?></label>
						</th>
						<td>
							<form></form>
							<?php
					...
					<tr id="envira-config-import-box">
						...
						<td>
							...
							<form id="envira-settings-verify-key" method="post">
								...
								<!-- <input type="submit" name="envira-gallery-deactivate-submit" id="envira-gallery-deactivate-submit" class="button" value="Deactivate Key"> -->	
								<!-- <p class="description">License key to enable automatic updates for Envira</p> -->
							</form>
