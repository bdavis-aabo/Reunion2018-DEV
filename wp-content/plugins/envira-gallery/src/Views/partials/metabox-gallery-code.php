...
<p><?php _e( 'You are able to use a special shortcode to open a gallery with a link:', 'envira-gallery' ); ?></p>
<div class="envira-code">
	<textarea readonly class="code-textfield" id="envira_template_tag_link_<?php echo $data['post']->ID; ?>">[envira-link id=&quot;<?php echo $data['post']->ID; ?>&quot;]Click here[/envira-link]</textarea>
...
<p><?php _e( 'You can place this gallery into your template files by using the template tag below:', 'envira-gallery' ); ?></p>
<div class="envira-code">
	<textarea readonly rows="2" class="code-textfield" id="envira_template_tag_id_<?php echo $data['post']->ID; ?>"><?php echo 'if ( function_exists( \'envira_gallery\' ) ) { envira_gallery( \'' . $data['post']->ID . '\' ); }'; ?></textarea>
