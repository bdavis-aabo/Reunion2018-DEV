				...
				<tbody>
					...
					<tr id="envira-config-videos-autoplay-box">
						...
						<td>
							...
							<span class="description"><?php _e( '(YouTube, Vimeo, Wistia, DailyMotion): Automatically begins playback of videos when they are displayed in the Lightbox view.', 'envira-videos' ); ?></span>
						</td>
					</tr>

					<tr id="envira-config-videos-enlarge-box">
						<th scope="row">
							<label for="envira-config-videos-enlarge"><?php _e( 'Force Larger Videos?', 'envira-videos' ); ?></label>
						</th>
						<td>
							<input id="envira-config-videos-enlarge" type="checkbox" name="<?php echo $key; ?>[videos_enlarge]" value="1" <?php checked( $instance->get_config( 'videos_enlarge', $instance->get_config_default( 'videos_enlarge' ) ), 1 ); ?> />
							<span class="description"><?php _e( '(YouTube, Vimeo, Wistia): Enlarge video to full screen instead of original size.', 'envira-videos' ); ?></span>
						</td>
					</tr>
					...
					<tr id="envira-config-videos-playpause-box">
						...
						<td>
							...
							<span class="description"><?php _e( '(YouTube, Wistia, DailyMotion, Self Hosted): Display play and pause controls on videos in the Lightbox view.', 'envira-videos' ); ?></span>
						</td>
					</tr>
