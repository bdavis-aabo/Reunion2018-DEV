...
class Settings {
						...
						<tr id="envira-video-facebook-api-id-box">
							...
							<td>
								...
								<p class="description">
									...
									<?php esc_html_e( 'Visit <a target="_blank" href="https://console.developers.google.com">console.developers.google.com</a>, and register a new project that has access to the YouTube API.  Refer to our <a href="http://enviragallery.com/docs/video-addon">Documentation</a> for full instructions.', 'envira-video' ); ?>
								</p>
							</td>
						</tr>
						<tr>
	...
	public function save() {
		...
		if ( ! wp_verify_nonce( $_POST['envira-video-nonce'], 'envira-video-nonce' ) ) {
		...
		// Save.
		$settings = array(
			'youtube_api_key' => esc_html( $_POST['envira-video-youtube-api-id'] ),
		);
