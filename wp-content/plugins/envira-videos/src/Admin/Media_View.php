...
class Media_View {
	...
	public function scripts() {
		...
		$version = ( defined( 'ENVIRA_DEBUG' ) && ENVIRA_DEBUG == 'true' ) ? $version = time() . '-' . ENVIRA_VIDEOS_VERSION : ENVIRA_VIDEOS_VERSION;
	...
	public function print_media_templates( $post_id ) {
		...
		<script type="text/html" id="tmpl-envira-videos-side-bar">
			<div class="media-sidebar">
				<div class="envira-gallery-meta-sidebar">
					...
					<p><?php _e( 'The image for each video is automatically created from the video link you supply. Video links can be from the below sources, including locally hosted video files. They <strong>must</strong> follow one of the formats listed:', 'envira-videos' ); ?></p>

					<div class="envira-gallery-accepted-urls modal-urls">
						<ul>
							<li>
								<strong><a href="#"><?php _e( 'YouTube URLs', 'envira-videos' ); ?></a></strong>
								<ul class="closed">
						...
						<ul>
							<li>
								<strong><a href="#"><?php _e( 'Vimeo URLs', 'envira-videos' ); ?></a></strong>
								<ul class="closed">
						...
						<ul>
							<li><strong><a href="#"><?php _e( 'Dailymotion URLs', 'envira-videos' ); ?></a></strong>
								<ul class="closed">
						...
						<ul>
							<li><strong><a href="#"><?php _e( 'Instagram URLs', 'envira-videos' ); ?></a></strong>
								<ul class="closed">
						...
						<ul>
							<li><strong><a href="#"><?php _e( 'Facebook URLs', 'envira-videos' ); ?></a></strong>
								<ul class="closed">
						...
						<ul>
							<li><strong><a href="#"><?php _e( 'Twitch URLs', 'envira-videos' ); ?></a></strong>
								<ul class="closed">
						...
						<ul>
							<li><strong><a href="#"><?php _e( 'VideoPress URLs', 'envira-videos' ); ?></a></strong>
								<ul class="closed">
						...
						<ul>
							<li><strong><a href="#"><?php _e( 'Wistia URLs', 'envira-videos' ); ?></a></strong>
								<ul class="closed">
						...
						<ul>
							<li><strong><a href="#"><?php _e( 'Local URLs', 'envira-videos' ); ?></a></strong>
								<ul class="closed">
		...
		<script type="text/html" id="tmpl-envira-videos-item">
			<div class="envira-videos-item">
				<div class="header-links">
					...
					<a href="#" class="envira-videos-delete" title="<?php _e( 'Remove', 'envira-videos' ); ?>"><?php _e( 'X', 'envira-videos' ); ?></a>
				</div>
				<!-- Title -->
				<div>
					<label>
		...
		<script type="text/html" id="tmpl-envira-meta-editor-video">
			...
			<label class="setting">
				<span class="name"><?php _e( 'Video Thumbnail', 'envira-videos' ); ?></span>
				...
				<span class="description">
					...
					<?php _e( 'If you wish to override auto-generated thumbnails from the video services you\'ve selected, upload it here.', 'envira-videos' ); ?>
				</span>
			</label>
